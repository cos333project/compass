...
#     "{} is required; students must also have completed PHY 101/102. Instructor approval needed for exceptions.",

# "{} is a hard prerequisite; COS 217 is recommended but not mandatory. Freshmen require special permission.",

# "Either MAT 202 or ORF 245 is required, along with a basic understanding of statistics. Not open to seniors without instructor consent.",

# "CHM 301 is essential; concurrent enrollment in BIO 101 is permitted. No first-year students without explicit approval.",

# "PSY 101 and a 200-level sociology course are prerequisites. The course is closed to undergraduates without instructor permission.",

# "ORF 307 or ECO 202 is necessary; students should also have a basic grasp of linear algebra. Exceptions made only by departmental approval.",

# "POL 345 and a course in statistics are required; students lacking these will not be considered. Juniors and seniors only.",

# "ECO 100 and ECO 101 are prerequisites. Not open to students who have taken ORF 309. Instructor permission is required for sophomores.",

# "MAT 203 or MAT 204 is compulsory; additional 300-level math courses recommended. Freshmen need special approval.",

# "{} and COS 226 are prerequisites; students must also be familiar with machine learning algorithms. No exceptions."
# ]
...
# num_samples = 11125 # Using a smaller number for demonstration, you can increase this

# # Generate positive and negative samples
# positive_samples = generate_unique_sentences(subjects_list, positive_phrases, 1, num_samples)
# negative_samples = generate_unique_sentences(subjects_list, negative_phrases, 0, num_samples)
...
# dataset_path = '/Users/minhtri/Desktop/Princeton/COS/COS 333/compass/backend/benchmark.csv'
