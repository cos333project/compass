...
if __name__ == '__main__':
    ...
    push_minor(Path("../minors/ASA.yaml").resolve())
    push_minor(Path("../minors/CHI.yaml").resolve())
    push_minor(Path("../minors/CLA.yaml").resolve())
    push_minor(Path("../minors/COS.yaml").resolve())
    push_minor(Path("../minors/CS.yaml").resolve())
    push_minor(Path("../minors/CWR.yaml").resolve())
    push_minor(Path("../minors/DAN.yaml").resolve())
    push_minor(Path("../minors/EAS.yaml").resolve())
    push_minor(Path("../minors/ENG.yaml").resolve())
    push_minor(Path("../minors/ENV.yaml").resolve())
    push_minor(Path("../minors/FIN.yaml").resolve())
    push_minor(Path("../minors/GHP.yaml").resolve())
    push_minor(Path("../minors/GSS.yaml").resolve())
    push_minor(Path("../minors/HIS.yaml").resolve())
    push_minor(Path("../minors/HSTM.yaml").resolve())
    push_minor(Path("../minors/HUM.yaml").resolve())
    push_minor(Path("../minors/JPN.yaml").resolve())
    push_minor(Path("../minors/JRN.yaml").resolve())
    push_minor(Path("../minors/KOR.yaml").resolve())
    push_minor(Path("../minors/LAO.yaml").resolve())
    push_minor(Path("../minors/LIN.yaml").resolve())
    push_minor(Path("../minors/MED.yaml").resolve())
    push_minor(Path("../minors/MPP.yaml").resolve())
    push_minor(Path("../minors/MQE.yaml").resolve())
    push_minor(Path("../minors/MSE.yaml").resolve())
    push_minor(Path("../minors/MUS.yaml").resolve())
    push_minor(Path("../minors/NEU.yaml").resolve())
    push_minor(Path("../minors/PHI.yaml").resolve())
    push_minor(Path("../minors/SAS.yaml").resolve())
    push_minor(Path("../minors/SLA.yaml").resolve())
    push_minor(Path("../minors/SML.yaml").resolve())
    push_minor(Path("../minors/TMT.yaml").resolve())
    push_minor(Path("../minors/TRA.yaml").resolve())
    push_minor(Path("../minors/VIS.yaml").resolve())
    push_minor(Path("../minors/VPL.yaml").resolve())
