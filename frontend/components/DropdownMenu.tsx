...
import { Profile, MenuItemProps, MajorMinorType } from "../types";
    ...
    <div>
      <Menu as="div" className="relative inline-block text-left">
        ...
        {isMenuOpen && (
          ...
          >
            <Menu.Items
              className="absolute right-0 mt-2 w-48 origin-top-right bg-white divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5">
              <div className="py-1">
                <MenuItem
                  isActive={false}
                  onClick={() => {
