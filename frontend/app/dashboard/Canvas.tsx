...
export function Canvas({
  ...
  const [initialContainer, setInitialContainer] = useState<UniqueIdentifier | null>(null);
    ...
    <>
      <DndContext
        ...
        onDragStart={({ active }) => {
          ...
          setInitialContainer(findContainer(active.id));
        ...
        onDragEnd={async ({ active, over }) => {
          ...
          if (initialContainer !== overContainer) {
            console.log('Moved containers! Updating and checking reqs...');
            console.log('initial container', initialContainer);
            console.log('over container', overContainer);
            updateCourses(courseId, semesterId, csrfToken);
            checkRequirements();
          }

          // I am not sure what the below does:
          if (overContainer) {
  ...
  function handleRemove(value: UniqueIdentifier, containerId: UniqueIdentifier) {
    ...
    updateCourses(value, findContainer(value), csrfToken);
    checkRequirements();
  }
